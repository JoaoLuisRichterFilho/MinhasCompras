        ...
        <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <View style={styles.modalHeader}>
                <Icons.Unlock height={24} width={24} style={styles.headerIcon}/>
                <Text style={styles.modalHeaderText}>Efetue o Login</Text>
              </View>
              <View style={styles.modalBody}>
                ...
                <View style={styles.userView}>
                  ...
                  <Text style={styles.label}>
                    <Icons.Lock color={'#333'} height={16} width={16}/> Senha
                  </Text>
              ...
              <View style={styles.modalFooter}>
                <TouchableOpacity
                  ...
                  >
                    <Icons.X height={16} width={16} style={styles.closeLoginIcon}/>
                ...
                <TouchableOpacity
                    ...
                    onPress={props.login}
                  >
                    <Icons.LogIn height={24} width={24} style={styles.okLoginIcon}/>
